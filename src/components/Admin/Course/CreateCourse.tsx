  ...
  let [createCourse,{isLoading,isSuccess,error}]=useCreateCourseMutation();
    ...
    const [courseContentData, setcourseContentData] = useState([{
      ...
      const handleSubmit=async()=>{
        ...
        const formatedBenefits=benefits.map((benefits)=>{ return { title:benefits.title}});
      
        //Format Prerequsites Array
        const formatedprerequisties=prerequisites.map((prerequisties)=>{return{ title:prerequisties.title}})
