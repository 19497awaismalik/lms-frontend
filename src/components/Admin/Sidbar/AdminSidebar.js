...
return (
  ...
  >
    ...
    <ProSidebar collapsed={isCollapsed} style={{position:"fixed",top:-10,overflowY:!isCollapsed?'auto':"",
    // width:isCollapsed?"5%":"18%"
    border:isCollapsed && theme==='light'?"2px solid #111c43":"",height: isCollapsed? "100vh" : "101vh" }}  className={`mt-0 pt-0   z-[999]`}>
