...
const CircularProgressWithLabel:FC<ProgressProps> =({value,open})=>{
      return (
...
// console.log({orderComparePercentage},{userComparePercentage});
  return (
    <>
     ...
     <div className=' flex flex-col-reverse  md:grid md:grid-cols-[75%,25%]'>
       <div className='md:m-8  mb-0 '>
         <UsersAnalytics isDashboard={true}/>
       </div>

       <div className=' !pt-[80px] md:pr-2 '>
           ...
           <div className=' flex items-center justify-between   p-4 '>
             ...
             <div >
               <CircularProgressWithLabel value={
                  orderComparePercentage?.percentChange!==undefined && orderComparePercentage?.percentChange > 0 ? 100:0
                 
               } open={open}/>
               <h1 className=' text-center pt-4  font-Poppins dark:text-white text-black text-[20px]'>
                  { orderComparePercentage?.percentChange!==undefined &&  orderComparePercentage?.percentChange>0?
         ...
         <CircularProgressWithLabel value={
          userComparePercentage?.percentChange!==undefined && userComparePercentage?.percentChange > 0 ? 100 : 0
         } open={open}/>
               <h1 className=' text-center pt-4  font-Poppins dark:text-white text-black text-[20px]'>
                 {userComparePercentage?.percentChange!==undefined && userComparePercentage?.percentChange > 0 ?
   ...
   {/* Order Analytics component layout */}
       <div className=' flex flex-col-reverse md:grid md:grid-cols-[63%,37%]    pt-8'>
       <div className='dark:bg-[#111c43] w-[94%] shadow-sm m-auto  '>
         ...
         <OrdersAnalytics isDashboard={true}/>
           ...
           <div className=' pr-1  md:my-0 my-3'>
