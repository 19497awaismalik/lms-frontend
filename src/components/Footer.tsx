    ...
    <div className=' w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto  sm:px-2 lg:px-8 '>
        <div className=' grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 md:text-left text-center '>
            ...
            <div className=' space-y-3 '>
                ...
                <ul className=' '>
                    <li>
                        <Link href='/phone' className='text-base text-black dark:text-gray-300 dark:hover:text-white '>Call Us:{" "} 03703502753</Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link href='/mailto:19497.awais@mao.edu.pk' className='text-base text-black dark:text-gray-300 dark:hover:text-white '>Mail Us: learningmanagementsystem17@gmai.com</Link>
                    </li>
