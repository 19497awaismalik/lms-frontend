            ...
            <div className=" flex items-center pt-3">
                    ...
                    <div className="w-[90%] 800px:w-[80%] m-auto block pb-4">
                        ...
                        <div className=" w-[100%] pt-3">
                            ...
                            <input type="password" className={`${styles.input} !w-[100%] mb-4 800px:mb-0`} required name='password' onChange={ChangeHandler} value={user.password} minLength={6} />
                        ...
                        <div className=" w-[100%] pt-3">
                            ...
                            <input type="password" className={`${styles.input} !w-[100%] mb-4 800px:mb-0`}   name='cpassword' onChange={ChangeHandler} value={user.cpassword} minLength={6}/>
