...
const ChangePassword:FC = () => {
    ...
    useEffect(()=>{
        ...
        if(error){
            ...
            toast.error((error as any)?.data.message||' Your Password not Change')
        }
        },[isSuccess,error])
  return (
    <div>
            ...
            <div className=" flex items-center pt-3">
                    ...
                    <div className="w-[90%] 800px:w-[80%] m-auto block pb-4">
                        <div className=" w-[100%] ">
                            ...
                            <input type="password" className={`${styles.input} !w-[100%] mb-4 800px:mb-0`} required  onChange={ChangeHandler} name='oldpassword'  value={user.oldpassword} autoComplete="false"/>

                        </div>
                        <div className=" w-[100%] pt-3">

                            <label htmlFor="" className=' block pb-1 font-Poppins dark:text-white text-black '>Enter your new password</label>
                            <input type="password" className={`${styles.input} !w-[100%] mb-4 800px:mb-0`} required name='password' onChange={ChangeHandler} value={user.password} minLength={6} autoComplete="false" />
                        ...
                        <div className=" w-[100%] pt-3">
                            ...
                            <input type="password" className={`${styles.input} !w-[100%] mb-4 800px:mb-0`}   name='cpassword' onChange={ChangeHandler} value={user.cpassword} minLength={6} autoComplete="false"/>
